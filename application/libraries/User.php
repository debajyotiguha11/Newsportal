    ...
    public function notify($iduser, $notification = 'new_signup') {
        ...
        switch($notification) {
            case 'welcome':
                ...
                $message = '<p>
                                Hello,<br />
                                Welcome to BCNI. We are really excited to see you on board. Hope you will enjoy your time here and enrich our portal with valuable contents.
                            </p>
                            <p>
                                Regards,<br />
                                BCNI Team
                ...
                $result = $this->ci->email
                    ->from('codersheadquarter@gmail.com')
            ...
            default:
                ...
                $message = '<p>
                                Hello,<br />
                                Thank you for joining the BCNI Portal. Please follow <a href="'.base_url('account/activate/'.$current_user->code).'">this link</a> to activate your account.
                            </p>
                            <p>
                                You can copy and paste the URL below if the link does not work:<br />
