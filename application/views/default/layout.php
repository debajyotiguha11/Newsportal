...
<link href="https://fonts.googleapis.com/icon?family=Material+Icons"
      rel="stylesheet">
	<style>.material-icons.red500 { color: #f44336; }</style>
    <!--[if lt IE 9]>
...
<div class="wrapper">
                ...
                <nav class="navbar navbar-default navbar-fixed-top">
                    <div class="container">
                        <div class="navbar-header">
                            ...
                            <?php endif; ?>
                            <a href="<?php echo base_url(); ?>" class="navbar-brand cursive logo">My News Portal</a>
                        </div>
                        <?php if(!isset($data['pdf']) || $data['pdf'] == FALSE): ?>
                        <div class="collapse navbar-collapse" id="new-portal-navbar">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:" role="button" aria-haspopup="true" aria-expanded="false">
                                        <i class="fa fa-fw fa-user"></i> Admin Area <span class="caret"></span>
                                    </a>
                                    <ul class="dropdown-menu">
                                        <?php if(!is_logged_in()): ?>
    ...
    <div class="container-fluid">
        ...
        <form method="post" action="subscribe2.php" class="form-inline">
            <div class="form-group">
                <label for="signup_email">Email</label>
                <input type="email"  name="email" id="email" placeholder="Valid email address" class="form-control" />
            </div>
            <button type="submit" class="btn btn-success">Subscribe</button>
                ...
                <div class="col-md-6 text-right">
                    <p>
                        &copy; <?php echo date('Y'); ?> Coders. All rights reserved.<br />
                        made with <i class="material-icons  red500">favorite</i> by coders <a href="http://coders.uphero.com/" target="_blank">CODERS</a>.
                    </p>
					<p>
					<a href="http://coders.uphero.com/" target="_blank"><font color="red">Author: Debjyoti Guha</font></a>
					</p>
                </div>
            </div>
        </div>
